...
#SBATCH --job-name=ptsd2019_ext_5yr
#
#Project:
#SBATCH --account=p471
#
...
ANALYSIS_SNAME="ptsd2019_ext_5yr"
# Filepath for inputs
...
BASE=${INM}/common/gwas_sumstats/ptsd2019_ext_5yr
...
--extract /cluster/p/p471/cluster/common/gwas_sumstats/duplicates/ptsd2019eur.valid \
--base $BASE \
--target $TARGET \
